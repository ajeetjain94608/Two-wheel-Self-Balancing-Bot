...
def sysCall_actuation():
    ...
    x1=sim.getJointTargetVelocity(21)
    
    #x5=sim.getObjectOrientation(22,sim.handle_world)
    x5=sim.getObjectOrientation(22,20)
    x2=sim.alphaBetaGammaToYawPitchRoll(x5[0],x5[1],x5[2])
    x3=sim.getJointTargetVelocity(23)
    x6=sim.getObjectOrientation(24,20)
    x4=sim.alphaBetaGammaToYawPitchRoll(x6[0],x6[1],x6[2])
    k = [  -1.003139 , -0.010000  , 0.953048 ,  6.973991]
   ...
   # U = k[0]*x1 - k[1]*(1.5707-x2[1]) + k[2]*x3 + k[3]*(-x4[0])
    ...
    #print(x4)
    #print(x4)
    sim.setJointTargetVelocity(21,U)
