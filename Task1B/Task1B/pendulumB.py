...
def sysCall_actuation():
    ...
    x1=sim.getJointTargetVelocity(26)
    
    #x5=sim.getObjectOrientation(22,sim.handle_world)
    x5=sim.getObjectOrientation(27,25)
    x2=sim.alphaBetaGammaToYawPitchRoll(x5[0],x5[1],x5[2])
    x3=sim.getJointTargetVelocity(28)
    x6=sim.getObjectOrientation(31,25)
    x4=sim.alphaBetaGammaToYawPitchRoll(x6[0],x6[1],x6[2])
    k = [ -1.13045 , -0.32100 ,  0.99539  , 7.23647]
   ...
   # U = k[0]*x1 - k[1]*(1.5707-x2[1]) + k[2]*x3 + k[3]*(-x4[0])
    ...
    print(U)
    #print(x4)
    sim.setJointTargetVelocity(28,U)
