...
float a[3] = {
    ...
    0,
    0
}; //stores accelerometer and gyro value
const float pi = 3.14159265359,
    f_cut = 5,
    dT = 0.003,
    comp_alpha = 0.01; //f_cut sampling frequency.
...
void cs() {
    ...
    if (sensorValueleft < 501 || sensorValueright < 501 && data.sw1==HIGH) {
        // Turn on the red LED
        analogWrite(red, 255);
          red1 = 1;
          }
    ...
    else if (sensorValueleft > 507 || sensorValueright > 507 && data.sw1==HIGH) {
